        ...
        <div class="card">
          ...
          <div class="row" style="margin: 10px">
            <form @submit.prevent="submit">
              ...
              <div
                class="row"
                v-for="idx in parseInt(destinationTotal)"
                :key="idx"
              >
              ...
              >
                <div class="col-md-2 col-12">
                  <div class="form-group">
                    ...
                    >
                    <button
                      @click="showGallery(n - 1)"
                      type="button"
                      class="btn bg-gradient-success"
                    >
                      <i class="fa fa-image" aria-hidden="true"></i> Choose
                      Image
                    </button>
                    <div class="col-md-6 col-12">
                      <img
                        :src="selectedMediaFilesList[n - 1]?.uri"
                ...
                <div v-show="showCurrentImageUpload[n - 1].show" class="row">
                  ...
                  <div class="form-group">
                    <label for="trip_description" style="display: block"
                      >Select Photos to Upload to Image Gallery(Multiple files
                      allowed)</label
                    >
                    <input
                      name="file"
                  ...
                  <div class="row">
                    <div
                      v-for="files in mediaFilesList"
                      class="col-lg-1 col-md-2 col-6"
                    >
                      <img
                        :src="files.uri"
                        class="img-fluid img-thumbnail"
                      ...
                      >
                        <button
                          @click="addOverViewGalleryImages(files.id, n - 1)"
                          type="button"
    ...
    refreshToGallery() {
      ...
      axios
        ...
        .then((result) => {
          ...
          result.data.media_files.forEach((item) => {
            console.log(item);
            this.mediaFilesList.value.push({
              id: item.id,
              uri: item.uri,
              description: item.title,
            });
          ...
          axios
            .post(
              newApiUrl,
              {
                ...
                time: "20:30",
                title: this.$refs.overview_title[i].value,
                content: this.$refs.overview_description[i].value,
                media_file_id: this.$refs.overview_image[i].value,
              },
              {
                headers: {
                  "Content-Type": "application/json",
