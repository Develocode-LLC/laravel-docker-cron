      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-header">
            <h5 class="mb-0">Live N Learn - Student Users</h5>
          </div>
          <div class="table-responsive">
            <table id="student-list" class="table table-flush">
...
export default {
  ...
  methods: {
    ...
    async loadDataTable() {
      ...
      const userDatatable = new DataTable("#student-list", {
        searchable: true,
        fixedHeight: true,
      });
      ...
      this.userList.forEach((user) => {
        ...
        let btnViewUser = `<a class="btn bg-gradient-info" href="/traveler/${user.id}">
