  ...
  setup() {
    ...
    axios.get(newApiUrl, {
      ...
      result.data.trips.forEach(function (programItem) {
        ...
        if (programItem.destination != null) {
          dest_city = programItem.destination.city;
        }


        let rowArray = new Array(programItem.title, programItem.type.toUpperCase(), programItem.code, orig_city, programItem.start_date, programItem.end_date, programItem.available_seats + " Seats", linkBtn);
