      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-header">
            <h5 class="mb-0">View Trip Details</h5>
            <p class="mb-0 text-sm">Use this tool to view Trip Details</p>
          </div>
              ...
              <div id="tabs" class="container">
                <div class="tabs">
                  ...
                  <a
                    ...
                    ><i class="fa fa-users" aria-hidden="true"></i> Travelers({{ travelersList.length }})</a
                  >
                  <a
                    v-on:click="activetab = '3'"
                    v-bind:class="[activetab === '3' ? 'active' : '']"
                    ><i class="fa fa-user" aria-hidden="true"></i> Coordinators({{ trip_local_coordinator.length }})
                  </a>
                  <a
                ...
                <div class="content">
                      ...
                      <form @submit.prevent="submit">
                        ...
                        <div class="form-group">
                          ...
                          <input
                            type="number"
                            class="form-control"
                            id="min_available_seats"
                            placeholder="Min Group Size"
                            v-model="min_available_seats"
                            min="1"
                            step="1"
                            required
                          />
                        ...
                        <div class="form-group">
                          ...
                          <input
                            type="number"
                            class="form-control"
                            id="max_available_seats"
                            placeholder="Max Group Size"
                            v-model="max_available_seats"
                            min="1"
                            step="1"
                            required
                          />
                        ...
                        <button
                          ...
                          class="btn bg-gradient-success"
                        >
                          <i class="fa fa-plane" aria-hidden="true"></i> Update
                          Trip Details
                        </button>
                      </form>
                  ...
                  <div v-if="activetab === '9'" class="tabcontent">
                    <div class="row">
                      ...
                      <div class="form-group">
                        <label for="country">Choose Group Leaders:</label>
                        <select class="form-select" id="type" v-model="person2">
                          <option value="Select Group Leader">
                            Select Group Leader
                          </option>
                          <option
                            v-for="(name, id) in groupLeaderList"
                            :value="name.id"
                            :label="name.name"
                            :key="id"
                          >
                      ...
                      <div class="form-group">
                        <button
                          @click="addGroupLeader()"
                          type="button"
                          class="btn bg-gradient-success"
                        >
                          <i class="fa fa-user" aria-hidden="true"></i> Add
                          Group Leader to Trip
                        </button>
                      </div>
                      <!-- <div class="form-group">
                        {{ userRows }}
                  ...
                  <div v-if="activetab === '7'" class="tabcontent">
                    <div class="row">
                      ...
                      <div class="form-group">
                        <label for="country">Choose Payment Option:</label>
                        <select class="form-select" id="type" v-model="payment">
                          <option value="">Select Option</option>
                          <option value="Full payment">Full payment</option>
                          <option value="Six Equal Payments">
                            Six Equal Payments
                          </option>
                          <option value="Three Equal Payments">
