                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <p class="mb-0 text-sm">
                            Use this tool to add a new Location to Live N Learn
                        </p>
                    </div>
                    <div class="row" style="margin:10px;">
                        <form>
                            ...
                            <!-- <div class="form-group">
                                <label for="location_radius">Area Radius</label>
                                <input type="number" class="form-control" id="location_radius" placeholder="Enter Radius">
                            </div> -->

                            <div v-if="showError" class="invalid-feedback2">{{ error.message }}</div>

                            <button type="button" @click="addLocation()" class="btn bg-gradient-success"><i
                                    class="fa fa-map-marker" aria-hidden="true"></i> Add Location</button>
...
export default {
    ...
    methods: {
        addLocation() {
            var newApiUrl = this.$store.state.apiUrl + 'location';
            axios.post(newApiUrl, {
                name: this.formdata.name,
                city: this.formdata.name,
