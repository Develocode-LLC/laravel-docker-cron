<template>
    <form @submit.prevent="submit" class="shadow-md rounded m-4 p-4">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    />
                    <small
                        v-if="showError && formData.trip_id.length <= 0"
                        id="traveler_fname-error"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="traveler_fname"> Traveler's First Name </label>
                    <input
                        type="text"
                        :class="{
                            'error-input':
                        ...
                        v-model="formData.traveler_fname"
                        required
                    />
                    <small
                        v-if="showError && formData.traveler_fname.length <= 0"
                        id="traveler_fname-error"
                        class="form-text text-danger text-sm font-weight-light"
                        >{{ error.message }}</small
                    >
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input
                        ...
                        v-model="formData.traveler_lname"
                        required
                    />
                    <small
                        v-if="showError && formData.traveler_lname.length <= 0"
                        id="lname-error"
                        class="form-text text-danger text-sm font-weight-light"
                    >
                        {{ error.message }}</small
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input
                        ...
                        v-model="formData.traveler_email"
                        required
                    />
                    <small
                        v-if="showError && formData.traveler_email.length <= 0"
                        id="lname-error"
                        class="form-text text-danger text-sm font-weight-light"
                    >
                        {{ error.message }}</small
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input
                        ...
                        v-model="formData.traveler_phone"
                        required
                    />
                    <small
                        v-if="showError && formData.traveler_phone.length <= 0"
                        id="lname-error"
                        class="form-text text-danger text-sm font-weight-light"
                    >
                        {{ error.message }}</small
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    />
                    <small
                        v-if="showError && formData.parent_email.length <= 0"
                        id="lname-error"
                        class="form-text text-danger text-sm font-weight-light"
                    >
                        {{ error.message }}</small
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    />
                    <small
                        v-if="showError && formData.parent_phone.length <= 0"
                        id="lname-error"
                        class="form-text text-danger text-sm font-weight-light"
                    >
                        {{ error.message }}</small
        ...
        <div class="w-100 d-flex justify-content-center">
            <button
                type="submit"
                class="btn bg-gradient-success submit-btn w-50"
