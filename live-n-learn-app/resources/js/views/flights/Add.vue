            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h5 class="mb-0">Add Outbound Flight</h5>
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="row" v-for="n in parseInt(departureFlightTotal)" :key="n">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select2 ref="origin_airport" :class="form - select" :data="airportList"
                                                value="0">
                                            </select2>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select2 ref="destination_airport" :class="form - select" :data="airportList"
                                                value="0">
                                            </select2>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select2 ref="dep_airline" value="0" :class="form - select"
                                        :data="airlineList">
                                    </select2>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="arrival_date"
                                                onfocus="this.showPicker()" ref="arrival_date" placeholder="Arrival Date"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="time" id="departure_time" ref="departure_time"
                                                placeholder="Departure Time" step="3600" min="00:00" max="23:59" pattern="[0-2][0-9]:[0-5][0-9]" required />
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="time" id="arrival_time" ref="arrival_time"
                                                placeholder="Arrival Time" step="3600" min="00:00" max="23:59" pattern="[0-2][0-9]:[0-5][0-9]" required />
                                        </div>
                                    </div>
                            ...
                            <div class="row" v-for="n in parseInt(returnFlightTotal)" :key="n">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="departure_city">Originating City</label>
                                            <select2 ref="ret_origin_airport" :class="form - select" :data="airportList"
                                                value="0">
                                            </select2>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="destination">Destination</label>
                                            <select2 ref="ret_destination_airport" :class="form - select"
                                                :data="airportList" value="0">
                                            </select2>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label for="airline">Airline</label>
                                    <select2 ref="ret_airline" value="Choose Airline" :class="form - select"
                                        :data="airlineList">
                                    </select2>
                                </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="time" id="departure_time"
                                                ref="ret_departure_time" step="3600" min="00:00" max="23:59" pattern="[0-2][0-9]:[0-5][0-9]" placeholder="Departure Time" required />
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
...
export default {
    ...
    setup() {
        ...
        //add default to airport list
        airportList.value.push({ value: '0', label: 'Select Airport' });
        ...
        axios.get(newApiUrl, {
            ...
            //console.log(result.data.airports);
            ...
            result.data.airports.forEach((airportItem, index) => {
                ...
                try {
                    airportList.value.push({ value: airportItem.id, label: airportItem.code + ' - ' + airportItem.city });
                }
                catch (err) {
                    console.log(err.message);
                }
    ...
    methods: {
        addFlight() {
            ...
            for (let i = 0; i < this.returnFlightTotal; i++) {
                ...
                //console.log(this.$refs.origin_airport[i].$data.hoveringValue);
                let flight_leg = i + 1;
