...
export default {
  ...
  setup() {
    ...
    //get flight details for trip
    var newApiUrl = store.state.apiUrl + "trip/" + paramId + "/trip_flight";
    ...
    axios
      ...
      .then((r) => {
        ...
        trip_id.value = result.data.departure_flights[0].trip_id;
      })
      .catch((e) => {
        console.error(e);
      });
    ...
    axios
      ...
      .then((r) => {
        ...
        result.data.airports.forEach((airportItem, index) => {
          airportList.value.push({
            value: airportItem.id.toString(),
            label: airportItem.code + " - " + airportItem.city,
          });
        });
    ...
    addFlight() {
      for (let i = 0; i < this.departureFlightTotal; i++) {
        ...
        let destination_airport =
          this.$refs.destination_airport[i].$data.hoveringValue;
      ...
      for (let i = 0; i < this.returnFlightTotal; i++) {
        ...
        let origin_airport =
          this.$refs.ret_origin_airport[i].$data.hoveringValue;

        let destination_airport =
          this.$refs.ret_destination_airport[i].$data.hoveringValue;
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-header">
            <h5 class="mb-0">Update Outbound Program Flights</h5>
          ...
          <div class="row" style="margin: 10px">
            <div class="form-group">
              <label for="destination">Trip Name</label>
              <select class="form-select" v-model="trip_id">
                <option value="">Select Trip</option>
                <option
                  v-for="(name, id) in tripsList"
                  :value="name.id"
                  :label="name.name"
                  :key="id"
                >
            ...
            <div
              class="row"
              v-for="flightInfo in departureFlightData"
              :key="flightInfo"
            >
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <!-- {{ flightInfo.origin_airport_id }} -->
                    <select2
                      ref="origin_airport"
                      :data="airportList"
                      :value="flightInfo.origin_airport_id.toString()"
                    >
                    </select2>
                  </div>
                </div>
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <!-- {{ flightInfo.destination_airport_id }} -->
                    <select2
                      ref="destination_airport"
                      :data="airportList2"
                      :value="flightInfo.destination_airport_id.toString()"
                    ></select2>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  :value="flightInfo.airline_flight_number"
                  required
                />
              </div>
                ...
                <div class="col-4">
                  <div class="form-group">
                    ...
                    <input
                      ...
                      @change="populateArrivalDate()"
                      ref="departure_date"
                      :value="flightInfo.departure_date"
              ...
              <div class="row">
                <div class="col-4">
                  <div class="form-group">
                    ...
                    <input
                      ...
                      :value="flightInfo.departure_time"
                      required
                    />
                  </div>
                </div>
                ...
                <div class="col-4">
                  <button
                    type="button"
                    @click="removeDepatureFlight()"
                    class="btn bg-gradient-warning"
                  >
                    <i class="fa fa-minus" aria-hidden="true"></i> Remove Flight
                    Leg
                  </button>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-4">
                <button
                  type="button"
                  @click="addDepartureFlight()"
                  class="btn bg-gradient-info"
                >
                  <i class="fa fa-plane" aria-hidden="true"></i> Add New
            ...
            <div
              class="row"
              v-for="flightInfo in returnFlightData"
              :key="flightInfo"
            >
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <select2
                      ref="ret_origin_airport"
                      :data="airportList3"
                      :value="flightInfo.origin_airport.id.toString()"
                    >
                    </select2>
                  </div>
                </div>
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <select2
                      ref="ret_destination_airport"
                      :data="airportList4"
                      :value="flightInfo.destination_airport.id.toString()"
                    >
                    </select2>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  class="form-control"
                  id="flight_number"
                  ref="ret_flight_number"
                  placeholder="Flight Number"
                  v-model="flightInfo.airline_flight_number"
                  required
                />
              </div>
                ...
                <div class="col-4">
                  <div class="form-group">
                    ...
                    <input
                      ...
                      id="departure_date"
                      onfocus="this.showPicker()"
                      @change="populateArrivalDate2()"
                      ref="ret_departure_date"
                      :value="flightInfo.departure_date"
                      placeholder="Departure Date"
                      required
                    />
            ...
            <div class="row">
              <div class="col-4">
                <button
                  type="button"
                  @click="addReturnFlight()"
                  class="btn bg-gradient-info"
                >
                  <i class="fa fa-plane" aria-hidden="true"></i> Add New Return
                  Flight Leg
                </button>
              </div>
            </div>
