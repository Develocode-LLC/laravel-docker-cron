<template>
    ...
    <div class="col">
        <button type="button" class="btn bg-gradient-success float-end" 
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="amount"
                                placeholder="Amount" v-model="formdata.amount">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="payment_notes" rows="3"
                                placeholder="Enter Notes here" v-model="formdata.notes"></textarea>
                        </div>
                    </div>
                </div>
            </div>
