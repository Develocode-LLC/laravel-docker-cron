<template>
  <nav
    ...
    :class="$store.state.isRTL ? 'top-1 position-sticky z-index-sticky' : ''"
    data-scroll="true"
  >
    <div class="px-3 py-1 container-fluid">
      <breadcrumbs :current-page="currentRouteName" :text-white="textWhite" />
      <div
        class="sidenav-toggler sidenav-toggler-inner d-block"
        ...
        >
          <div class="input-group z-index-1">
            ...
            <input
              ...
              class="form-control"
              :placeholder="
                $store.state.isRTL ? 'أكتب هنا...' : 'Search Here...'
              "
            />
          </div>
        </div>
...
export default {
  ...
  methods: {
    doLogout() {
      var newApiUrl = this.$store.state.apiUrl + "logout";
      axios
        .post(
          newApiUrl,
          {},
